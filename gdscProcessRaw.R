...
gdsc_sens <- fread(file.path("/pfs/in", myInFile_8.2))
...
load("/pfs/drugInfo/drugInfo_8.2.RData")
load("/pfs/cellInfo/cellInfo_8.2.RData")
...
for(i in seq_along(sens.raw.x)){
  ...
  slce <- sens.raw[sens.raw.x[[i]],,]
  saveRDS(slce, file=paste0("/pfs/out/slices/gdsc_raw_sens_8.2_", i, ".rds"))
